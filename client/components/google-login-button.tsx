...
export function GoogleLoginButton({ callbackUrl = "/menu" }: { callbackUrl?: string }) {
  ...
  return (
    <button
      ...
      className="mt-6 flex w-full items-center justify-center gap-3 rounded-full border border-stone-200 bg-white px-5 py-3 font-black text-stone-950 shadow-sm transition hover:border-[#e23744] hover:bg-[#fff7f7] disabled:cursor-wait disabled:opacity-70"
    >
